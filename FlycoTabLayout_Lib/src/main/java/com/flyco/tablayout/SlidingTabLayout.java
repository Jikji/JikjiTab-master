...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTabPadding = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? dp2px(0) : dp2px(17));
    ...
    public void setViewPager(ViewPager vp, String[] titles, ArrayList<CustomTabEntity> tabEntitys) {
...
//            Integer pageResource = mResources == null ? -1 : mResources.get(i);
    ...
    private void addTab(final int position, String title, View tabView) {
        ...
        if (iv_tab_image != null) {
            if (mTabEntitys != null && mTabEntitys.size() > 0) {
                iv_tab_image.setImageResource(mTabEntitys.get(position).getTabUnselectedIcon());
            }else{
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            ImageView iv_tab_image = (ImageView) v.findViewById(R.id.iv_tab_icon);
            if(iv_tab_image != null){
                if(mTabEntitys != null && mTabEntitys.size() > 0){
                    CustomTabEntity tabEntity = mTabEntitys.get(i);
                    iv_tab_image.setImageResource(i == mCurrentTab ? tabEntity.getTabSelectedIcon() : tabEntity.getTabUnselectedIcon());
                    ...
                    lp.leftMargin = (int) mIconLeftMargin;


                    iv_tab_image.setLayoutParams(lp);
                }else{
                    iv_tab_image.setVisibility(View.GONE);
                }
            }
